    ...
    <div class="container-820px">
        <div class="justtext" style="min-height: 910px;">
            ...
            <div class="green_container">
                ...
                <p><strong>Сryptex24 counteraction to money laundering</strong></p>
                <p>Undoubtedly, Сryptex24 service represents particular interest for laundering of illegally obtained money, so the company adheres strict policy against money laundering. Counteraction to money laundering is based on existing Russian and international enactments, and pursues the purpose to prevent any possibility of illegal transactions using Сryptex24 service.</p>
            ...
            <div class="white_container">
                ...
                <p>The term ""money laundering"" means actions aimed at the legalization of funds obtained as a result of any criminal activity. The purpose of money laundering is to hide the origin of the funds received by an illegal way, with their ensuing entry into the official economy.</p>
                <p>The money laundering procedure consists of three main steps:</p>
                <p>At the first stage, the funds gained by criminal way, <a href="" class="underlined text-link--green">Link will be here </a> pouring into the overall financial flow, usually by placing money on bank accounts as money orders, etc. As the market of the electronic payment systems (EPS) has been developed, schemes, that transfer funds to the accounts in the EPS as non-cash payments, have been increasingly used.</p>
                <p>At the second step, the funds are being transferred, whereby the way to the origin of these funds is lost. At the third step the funds, are being integrated into the official economy, it can be done by purchasing assets, financing legal business, etc.</p>
                <p>It should be noted that money laundering is quite often used for financing criminal (including terrorist) activities; however, in this case the purpose of money laundering is to hide the ways of financing illegal organizations.</p>
                <p>Signs of money money laundering activities</p>
                <ul>
                    <li>The client expresses concern or dissatisfaction with the Anti-Money Laundering policy;</li>
                    <li>The client tries to hide the personal data, that is necessary for his/her identification;</li>
                    <li>The client provides false data, that is necessary for his/her identification;</li>
