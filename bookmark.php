<div class="bookmark">
    ...
    <div class="bookmark__tab">
        ...
        <div class="bookmark__item bookmark__item--reserve bookmark__item--active">
            <ul>
                <li class="bookmark__row bookmark__header flexbox">
                    <div class="bookmark__col"><span>Payment system</span></div>
                    <div class="bookmark__col"><span>Reserve</span></div>
                </li>
                <li class="bookmark__row bookmark__body flexbox">
                    <div class="bookmark__col"><span>Visa Credit/Debit Card USD</span></div>
                    <div class="bookmark__col"><span>14000 usd</span></div>
                </li>
                <li class="bookmark__row bookmark__body flexbox">
                    <div class="bookmark__col"><span>Perfectmoney</span></div>
                    <div class="bookmark__col"><span>45000 usd</span></div>
                </li>
                <li class="bookmark__row bookmark__body flexbox">
                    <div class="bookmark__col"><span>Bitcoin</span></div>
                    <div class="bookmark__col"><span>500 usd</span></div>
                </li>
            </ul>
        </div>
        ...
        <div class="bookmark__item bookmark__item--best">
            <ul>
                <li class="bookmark__row bookmark__header flexbox">
                    <div class="bookmark__col"><span>Give</span></div>
        ...
        <div class="bookmark__item bookmark__item--exchange">
            ...
            <div class="bookmark__row bookmark__header flexbox">
                <div class="bookmark__col">
                    <span>Give</span>
                </div>
                <div class="bookmark__col">
                    <span>Get</span>
            ...
            <div class="flexbox">
                ...
                <ul class="bookmark__col exchange-switch">
                    <li class="wm">
                        <div class="bookmark__row bookmark__body">
                    ...
                    <li class="bookmark__body--hidden sb">
                        <div class="bookmark__row bookmark__body">
                            <a href="#" class="underlined exchange-to">Qiwi</a>
                        </div>
                        <div class="bookmark__row bookmark__body">
                    ...
                    <li class="bookmark__body--hidden qiwi">
                        <div class="bookmark__row bookmark__body">
                            <a href="#" class="underlined exchange-to ">Visa Credit/Debit Card USD</a>
                        </div>
                        <div class="bookmark__row bookmark__body">
                            <a href="#" class="underlined exchange-to ">Western Union</a>
                        </div>
                    ...
                    <li class="bookmark__body--hidden pm">
                        <div class="bookmark__row bookmark__body">
                            <a href="#" class="underlined exchange-to ">Webmoney</a>
                        </div>
                        <div class="bookmark__row bookmark__body">
